...
<div id="body">
	...
	<div class="row" style="margin-bottom: -240px;">
            ...
            <div class="col-md-10">
			<div class="row-1" >
				<h2><strong>Thêm mới đơn vị</strong></h2>
                 
                    <form action="<?php echo base_url(); ?>Donvi_Controller/them_donvi" method="POST">
    					<select name="id_parent" style="width: 80%; display: inline-block; border: none; background: #DDDDDD; padding: 15px; margin: 5px 0 22px 0;">
                            <option value="0">--- Chọn cấp đơn vị ---</option>
                            <?php
                        ...
                        <h4 style="color: black;">Tên đơn vị</h4><input type="text" name="tendonvi" style="width: 80%;" required/>
                        <h4 style="color: black;">Địa chỉ</h4>
                        <select name="id_parent" style="width: 80%; display: inline-block; border: none; background: #DDDDDD; padding: 15px; margin: 5px 0 22px 0;">
                            <option value="0">--- Chọn cấp địa giới ---</option>
                            <?php
                        ...
                        <h4 style="color: black;">Email</h4><input type="text" name="email" style="width: 80%;" required/>
                        <h4 style="color: black;">Số điện thoại</h4><?php echo form_error('sdt'); ?><input type="text" name="sdt" style="width: 80%;" required/>
