	...
	<div class="navbar navbar-default" style="background-color:#CC99FF; height:10px; margin-bottom: initial; font-size: 12px;">
			<div class="container" >
				...
				<ul class="nav navbar-nav navbar-right">
					<li><a href="index.php/Login_Controllers/dangnhap" style="color: #FFFF33;"><span class="glyphicon glyphicon-log-in"></span> Đăng nhập/Đăng ký</a></li>
				</ul>
			...
			<div>
				<div class="collapse navbar-collapse" id="myNavbar" >
					...
					<ul class="dropdown-menu">
						<li><a href="index.php/Main/taobieumau"style="color: #0099CC; font-weight: 600;">TẠO BIỂU MẪU</a></li>
					</ul>
						</li>
					...
					<div class="carousel-caption">
						...
						<p data-wow-duration="1000ms" class="wow slideInRight animated">.</p>
							<ul class="fa-ul text-center">
								...
								<li><a href="index.php/Main/taobieumau" class="page-scroll btn btn-xl">Chuyển đến Form Biểu mẫu</a></li>
							</ul>
					</div>
				</div>
				<div class="item">
					...
					<div class="intro-heading-1" data-wow-duration="700ms" data-wow-delay="500ms">NHỮNG BIỂU MẪU TỐT NHẤT</div>
						...
						<ul class="fa-ul text-center">
							<li><a href="" style="color: white;"><i class="fa fa-twitter fa-lg"></i></a></li>
							<li><a href="" style="color: white;"><i class="fa fa-facebook fa-lg"></i></a></li>
							<li><a href="" style="color: white;"><i class="fa fa-google-plus fa-lg"></i></a></li>
							<li><a href="index.php/Main/taobieumau" class="page-scroll btn btn-xl">Chuyển đến Form Biểu mẫu</a></li>
						</ul>
					</div>
				</div>
