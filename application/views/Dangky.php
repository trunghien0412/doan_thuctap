...
<div id="body">
	...
	<div class="container-fluid-2">
        <h2 style="text-align: center;"><strong>Tạo tài khoản</strong></h2>	
				<hr>
			<div class="col-md-6" style="width: 100%; margin-top: 55px; margin-bottom: 140px;">
				
                <div id="form-center" class="col-md-6">				
				
						<form action="<?php echo base_url(); ?>Quantri_Controllers/them_nguoidung" method="POST">
						<h4><label for="user"><b>Tên tài khoản</b></label></h4>
						<input type="text" placeholder="Username" name="user" style="width: 100%;"required>
						
						<br>

						<h4><label for="dpn"><b>Tên hiển thị</b></label></h4>
						<input type="text" placeholder="Display Name" name="displayname" style="width: 100%;" required>
				
						<br>

						<h4><label for="pwd"><b>Mật khẩu</b></label></h4>
						<input type="password" placeholder="Password" name="pass" style="width: 100%;"required>
                        
                        <br>

						<h4><label for="pwd"><b>Xác nhận mật khẩu</b></label></h4>
						<?php echo form_error('c_pass'); ?><input type="password" placeholder="Confirm Password" name="c_pass" style="width: 100%;"required>
            ...
            <div class="col-md-6" style="width: 100%; margin-top: -589px; margin-bottom: 140px; margin-left: 535px;">
				<div id="form-center-right" class="col-md-6">				
						...
						<?php echo form_error('email'); ?><input type="text" placeholder="Email" name="email" style="width: 100%;"required>
